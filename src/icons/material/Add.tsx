...
// Sharp
import AddSharp500Fill from "@material-symbols/svg-500/sharp/add-fill.svg";
import AddSharp500 from "@material-symbols/svg-500/sharp/add.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type AddProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Add = forwardRef<SVGSVGElement, AddProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
