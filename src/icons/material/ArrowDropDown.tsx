...
// Sharp
import ArrowDropDownSharp500Fill from "@material-symbols/svg-500/sharp/arrow_drop_down-fill.svg";
import ArrowDropDownSharp500 from "@material-symbols/svg-500/sharp/arrow_drop_down.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ArrowDropDownProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ArrowDropDown = forwardRef<SVGSVGElement, ArrowDropDownProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ArrowDropDownSharp500Fill,
        },
        false: {
          500: ArrowDropDownSharp500,
        },
      },
    };
