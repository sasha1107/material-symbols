...
// Sharp
import ArrowDropUpSharp500Fill from "@material-symbols/svg-500/sharp/arrow_drop_up-fill.svg";
import ArrowDropUpSharp500 from "@material-symbols/svg-500/sharp/arrow_drop_up.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ArrowDropUpProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ArrowDropUp = forwardRef<SVGSVGElement, ArrowDropUpProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ArrowDropUpSharp500Fill,
        },
        false: {
          500: ArrowDropUpSharp500,
        },
      },
    };
