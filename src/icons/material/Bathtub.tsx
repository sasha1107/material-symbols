...
// Sharp
import BathtubSharp500Fill from "@material-symbols/svg-500/sharp/bathtub-fill.svg";
import BathtubSharp500 from "@material-symbols/svg-500/sharp/bathtub.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type BathtubProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Bathtub = forwardRef<SVGSVGElement, BathtubProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
