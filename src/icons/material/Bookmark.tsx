...
// Sharp
import BookmarkSharp500Fill from "@material-symbols/svg-500/sharp/bookmark-fill.svg";
import BookmarkSharp500 from "@material-symbols/svg-500/sharp/bookmark.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type BookmarkProps = IconProps<TVariant, TWeight> &
...
const Bookmark = forwardRef<SVGSVGElement, BookmarkProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: BookmarkSharp500Fill,
        },
        false: {
          500: BookmarkSharp500,
        },
      },
    };
