...
// Sharp
import BusinessCenterSharp500Fill from "@material-symbols/svg-500/sharp/business_center-fill.svg";
import BusinessCenterSharp500 from "@material-symbols/svg-500/sharp/business_center.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type BusinessCenterProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const BusinessCenter = forwardRef<SVGSVGElement, BusinessCenterProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: BusinessCenterSharp500Fill,
        },
        false: {
          500: BusinessCenterSharp500,
        },
      },
    };
