...
// Sharp
import CalendarMonthSharp500Fill from "@material-symbols/svg-500/sharp/calendar_month-fill.svg";
import CalendarMonthSharp500 from "@material-symbols/svg-500/sharp/calendar_month.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type CalendarMonthProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const CalendarMonth = forwardRef<SVGSVGElement, CalendarMonthProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: CalendarMonthSharp500Fill,
        },
        false: {
          500: CalendarMonthSharp500,
        },
      },
    };
