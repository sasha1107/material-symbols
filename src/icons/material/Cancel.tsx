...
// Sharp
import CancelSharp500Fill from "@material-symbols/svg-500/sharp/cancel-fill.svg";
import CancelSharp500 from "@material-symbols/svg-500/sharp/cancel.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type CancelProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Cancel = forwardRef<SVGSVGElement, CancelProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
