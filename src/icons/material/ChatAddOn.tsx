...
// Sharp
import ChatAddOnSharp500Fill from "@material-symbols/svg-500/sharp/chat_add_on-fill.svg";
import ChatAddOnSharp500 from "@material-symbols/svg-500/sharp/chat_add_on.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ChatAddOnProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ChatAddOn = forwardRef<SVGSVGElement, ChatAddOnProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ChatAddOnSharp500Fill,
        },
        false: {
          500: ChatAddOnSharp500,
        },
      },
    };
