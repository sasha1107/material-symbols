...
// Sharp
import ChecklistSharp500Fill from "@material-symbols/svg-500/sharp/checklist-fill.svg";
import ChecklistSharp500 from "@material-symbols/svg-500/sharp/checklist.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ChecklistProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Checklist = forwardRef<SVGSVGElement, ChecklistProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ChecklistSharp500Fill,
        },
        false: {
          500: ChecklistSharp500,
        },
      },
    };
