...
// Sharp
import ChevronLeftSharp500Fill from "@material-symbols/svg-500/sharp/chevron_left-fill.svg";
import ChevronLeftSharp500 from "@material-symbols/svg-500/sharp/chevron_left.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ChevronLeftProps = IconProps<TVariant, TWeight> &
...
const ChevronLeft = forwardRef<SVGSVGElement, ChevronLeftProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: ChevronLeftSharp500Fill,
        },
        false: {
          500: ChevronLeftSharp500,
        },
      },
    };
