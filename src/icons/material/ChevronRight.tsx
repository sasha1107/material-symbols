...
// Sharp
import ChevronRightSharp500Fill from "@material-symbols/svg-500/sharp/chevron_right-fill.svg";
import ChevronRightSharp500 from "@material-symbols/svg-500/sharp/chevron_right.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ChevronRightProps = IconProps<TVariant, TWeight> &
...
const ChevronRight = forwardRef<SVGSVGElement, ChevronRightProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: ChevronRightSharp500Fill,
        },
        false: {
          500: ChevronRightSharp500,
        },
      },
    };
