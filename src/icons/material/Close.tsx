...
// Sharp
import CloseSharp500Fill from "@material-symbols/svg-500/sharp/close-fill.svg";
import CloseSharp500 from "@material-symbols/svg-500/sharp/close.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type CloseProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Close = forwardRef<SVGSVGElement, CloseProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
