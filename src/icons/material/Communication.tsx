...
// Sharp
import CommunicationSharp500Fill from "@material-symbols/svg-500/sharp/communication-fill.svg";
import CommunicationSharp500 from "@material-symbols/svg-500/sharp/communication.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type CommunicationProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Communication = forwardRef<SVGSVGElement, CommunicationProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: CommunicationSharp500Fill,
        },
        false: {
          500: CommunicationSharp500,
        },
      },
    };
