...
// Sharp
import ConstructionSharp500Fill from "@material-symbols/svg-500/sharp/construction-fill.svg";
import ConstructionSharp500 from "@material-symbols/svg-500/sharp/construction.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ConstructionProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Construction = forwardRef<SVGSVGElement, ConstructionProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ConstructionSharp500Fill,
        },
        false: {
          500: ConstructionSharp500,
        },
      },
    };
