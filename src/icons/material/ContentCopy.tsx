...
// Sharp
import ContentCopySharp500Fill from "@material-symbols/svg-500/sharp/content_copy-fill.svg";
import ContentCopySharp500 from "@material-symbols/svg-500/sharp/content_copy.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ContentCopyProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ContentCopy = forwardRef<SVGSVGElement, ContentCopyProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ContentCopySharp500Fill,
        },
        false: {
          500: ContentCopySharp500,
        },
      },
    };
