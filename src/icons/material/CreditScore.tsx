...
// Sharp
import CreditScoreSharp500Fill from "@material-symbols/svg-500/sharp/credit_score-fill.svg";
import CreditScoreSharp500 from "@material-symbols/svg-500/sharp/credit_score.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type CreditScoreProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const CreditScore = forwardRef<SVGSVGElement, CreditScoreProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: CreditScoreSharp500Fill,
        },
        false: {
          500: CreditScoreSharp500,
        },
      },
    };
