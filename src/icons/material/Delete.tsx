...
// Sharp
import DeleteSharp500Fill from "@material-symbols/svg-500/sharp/delete-fill.svg";
import DeleteSharp500 from "@material-symbols/svg-500/sharp/delete.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type DeleteProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Delete = forwardRef<SVGSVGElement, DeleteProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
