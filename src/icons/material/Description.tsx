...
// Sharp
import DescriptionSharp500Fill from "@material-symbols/svg-500/sharp/description-fill.svg";
import DescriptionSharp500 from "@material-symbols/svg-500/sharp/description.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type DescriptionProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Description = forwardRef<SVGSVGElement, DescriptionProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: DescriptionSharp500Fill,
        },
        false: {
          500: DescriptionSharp500,
        },
      },
    };
