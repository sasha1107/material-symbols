...
// Sharp
import DownloadSharp500Fill from "@material-symbols/svg-500/sharp/download-fill.svg";
import DownloadSharp500 from "@material-symbols/svg-500/sharp/download.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type DownloadProps = IconProps<TVariant, TWeight> &
...
const Download = forwardRef<SVGSVGElement, DownloadProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: DownloadSharp500Fill,
        },
        false: {
          500: DownloadSharp500,
        },
      },
    };
