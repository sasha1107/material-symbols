...
// Sharp
import EditNoteSharp500Fill from "@material-symbols/svg-500/sharp/edit_note-fill.svg";
import EditNoteSharp500 from "@material-symbols/svg-500/sharp/edit_note.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type EditNoteProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const EditNote = forwardRef<SVGSVGElement, EditNoteProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: EditNoteSharp500Fill,
        },
        false: {
          500: EditNoteSharp500,
        },
      },
    };
