...
// Sharp
import ExploreSharp500Fill from "@material-symbols/svg-500/sharp/explore-fill.svg";
import ExploreSharp500 from "@material-symbols/svg-500/sharp/explore.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ExploreProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Explore = forwardRef<SVGSVGElement, ExploreProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
