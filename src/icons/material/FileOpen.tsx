...
// Sharp
import FileOpenSharp500Fill from "@material-symbols/svg-500/sharp/file_open-fill.svg";
import FileOpenSharp500 from "@material-symbols/svg-500/sharp/file_open.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type FileOpenProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const FileOpen = forwardRef<SVGSVGElement, FileOpenProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: FileOpenSharp500Fill,
        },
        false: {
          500: FileOpenSharp500,
        },
      },
    };
