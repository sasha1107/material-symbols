...
// Sharp
import FilePresentSharp500Fill from "@material-symbols/svg-500/sharp/file_present-fill.svg";
import FilePresentSharp500 from "@material-symbols/svg-500/sharp/file_present.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type FilePresentProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const FilePresent = forwardRef<SVGSVGElement, FilePresentProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: FilePresentSharp500Fill,
        },
        false: {
          500: FilePresentSharp500,
        },
      },
    };
