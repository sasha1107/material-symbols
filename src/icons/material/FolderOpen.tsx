...
// Sharp
import FolderOpenSharp500Fill from "@material-symbols/svg-500/sharp/folder_open-fill.svg";
import FolderOpenSharp500 from "@material-symbols/svg-500/sharp/folder_open.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type FolderOpenProps = IconProps<TVariant, TWeight> &
...
const FolderOpen = forwardRef<SVGSVGElement, FolderOpenProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: FolderOpenSharp500Fill,
        },
        false: {
          500: FolderOpenSharp500,
        },
      },
    };
