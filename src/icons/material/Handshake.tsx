...
// Sharp
import HandshakeSharp500Fill from "@material-symbols/svg-500/sharp/handshake-fill.svg";
import HandshakeSharp500 from "@material-symbols/svg-500/sharp/handshake.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type HandshakeProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Handshake = forwardRef<SVGSVGElement, HandshakeProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: HandshakeSharp500Fill,
        },
        false: {
          500: HandshakeSharp500,
        },
      },
    };
