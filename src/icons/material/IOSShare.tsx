...
// Sharp
import IOSShareSharp500Fill from "@material-symbols/svg-500/sharp/ios_share-fill.svg";
import IOSShareSharp500 from "@material-symbols/svg-500/sharp/ios_share.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type IOSShareProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const IOSShare = forwardRef<SVGSVGElement, IOSShareProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: IOSShareSharp500Fill,
        },
        false: {
          500: IOSShareSharp500,
        },
      },
    };
