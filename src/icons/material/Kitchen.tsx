...
// Sharp
import KitchenSharp500Fill from "@material-symbols/svg-500/sharp/kitchen-fill.svg";
import KitchenSharp500 from "@material-symbols/svg-500/sharp/kitchen.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type KitchenProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Kitchen = forwardRef<SVGSVGElement, KitchenProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
