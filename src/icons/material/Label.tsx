...
// Sharp
import LabelSharp500Fill from "@material-symbols/svg-500/sharp/label-fill.svg";
import LabelSharp500 from "@material-symbols/svg-500/sharp/label.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type LabelProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Label = forwardRef<SVGSVGElement, LabelProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
