...
// Sharp
import ListAltSharp500Fill from "@material-symbols/svg-500/sharp/list_alt-fill.svg";
import ListAltSharp500 from "@material-symbols/svg-500/sharp/list_alt.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ListAltProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ListAlt = forwardRef<SVGSVGElement, ListAltProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
