...
// Sharp
import ManageAccountsSharp500Fill from "@material-symbols/svg-500/sharp/manage_accounts-fill.svg";
import ManageAccountsSharp500 from "@material-symbols/svg-500/sharp/manage_accounts.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ManageAccountsProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const ManageAccounts = forwardRef<SVGSVGElement, ManageAccountsProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: ManageAccountsSharp500Fill,
        },
        false: {
          500: ManageAccountsSharp500,
        },
      },
    };
