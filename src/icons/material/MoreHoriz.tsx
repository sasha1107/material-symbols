...
// Sharp
import MoreHorizSharp500Fill from "@material-symbols/svg-500/sharp/more_horiz-fill.svg";
import MoreHorizSharp500 from "@material-symbols/svg-500/sharp/more_horiz.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type MoreHorizProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const MoreHoriz = forwardRef<SVGSVGElement, MoreHorizProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: MoreHorizSharp500Fill,
        },
        false: {
          500: MoreHorizSharp500,
        },
      },
    };
