...
// Sharp
import NotificationsSharp500Fill from "@material-symbols/svg-500/sharp/notifications-fill.svg";
import NotificationsSharp500 from "@material-symbols/svg-500/sharp/notifications.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type NotificationsProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Notifications = forwardRef<SVGSVGElement, NotificationsProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: NotificationsSharp500Fill,
        },
        false: {
          500: NotificationsSharp500,
        },
      },
    };
