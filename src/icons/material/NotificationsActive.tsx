...
// Sharp
import NotificationsActiveSharp500Fill from "@material-symbols/svg-500/sharp/notifications_active-fill.svg";
import NotificationsActiveSharp500 from "@material-symbols/svg-500/sharp/notifications_active.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type NotificationsActiveProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const NotificationsActive = forwardRef<SVGSVGElement, NotificationsActiveProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: NotificationsActiveSharp500Fill,
        },
        false: {
          500: NotificationsActiveSharp500,
        },
      },
    };
