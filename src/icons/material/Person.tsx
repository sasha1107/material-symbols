...
// Sharp
import PersonSharp500Fill from "@material-symbols/svg-500/sharp/person-fill.svg";
import PersonSharp500 from "@material-symbols/svg-500/sharp/person.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type PersonProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Person = forwardRef<SVGSVGElement, PersonProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
