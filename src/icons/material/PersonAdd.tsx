...
// Sharp
import PersonAddSharp500Fill from "@material-symbols/svg-500/sharp/person_add-fill.svg";
import PersonAddSharp500 from "@material-symbols/svg-500/sharp/person_add.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type PersonAddProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const PersonAdd = forwardRef<SVGSVGElement, PersonAddProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: PersonAddSharp500Fill,
        },
        false: {
          500: PersonAddSharp500,
        },
      },
    };
