...
// Sharp
import PhoneIPhoneSharp500Fill from "@material-symbols/svg-500/sharp/phone_iphone-fill.svg";
import PhoneIPhoneSharp500 from "@material-symbols/svg-500/sharp/phone_iphone.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type PhoneIPhoneProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const PhoneIPhone = forwardRef<SVGSVGElement, PhoneIPhoneProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: PhoneIPhoneSharp500Fill,
        },
        false: {
          500: PhoneIPhoneSharp500,
        },
      },
    };
