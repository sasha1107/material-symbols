...
// Sharp
import PhotoCameraSharp500Fill from "@material-symbols/svg-500/sharp/photo_camera-fill.svg";
import PhotoCameraSharp500 from "@material-symbols/svg-500/sharp/photo_camera.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type PhotoCameraProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const PhotoCamera = forwardRef<SVGSVGElement, PhotoCameraProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: PhotoCameraSharp500Fill,
        },
        false: {
          500: PhotoCameraSharp500,
        },
      },
    };
