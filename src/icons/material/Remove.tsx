...
// Sharp
import RemoveSharp500Fill from "@material-symbols/svg-500/sharp/remove-fill.svg";
import RemoveSharp500 from "@material-symbols/svg-500/sharp/remove.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type RemoveProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Remove = forwardRef<SVGSVGElement, RemoveProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
