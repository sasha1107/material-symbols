...
// Sharp
import ReplaySharp500Fill from "@material-symbols/svg-500/sharp/replay-fill.svg";
import ReplaySharp500 from "@material-symbols/svg-500/sharp/replay.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type ReplayProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const Replay = forwardRef<SVGSVGElement, ReplayProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
