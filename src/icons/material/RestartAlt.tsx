...
// Sharp
import RestartAltSharp500Fill from "@material-symbols/svg-500/sharp/restart_alt-fill.svg";
import RestartAltSharp500 from "@material-symbols/svg-500/sharp/restart_alt.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type RestartAltProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const RestartAlt = forwardRef<SVGSVGElement, RestartAltProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: RestartAltSharp500Fill,
        },
        false: {
          500: RestartAltSharp500,
        },
      },
    };
