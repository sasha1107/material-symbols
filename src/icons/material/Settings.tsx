...
// Sharp
import SettingsSharp500Fill from "@material-symbols/svg-500/sharp/settings-fill.svg";
import SettingsSharp500 from "@material-symbols/svg-500/sharp/settings.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type SettingsProps = IconProps<TVariant, TWeight> &
...
const Settings = forwardRef<SVGSVGElement, SettingsProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: SettingsSharp500Fill,
        },
        false: {
          500: SettingsSharp500,
        },
      },
    };
