...
// Sharp
import SupervisorAccountSharp500Fill from "@material-symbols/svg-500/sharp/supervisor_account-fill.svg";
import SupervisorAccountSharp500 from "@material-symbols/svg-500/sharp/supervisor_account.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type SupervisorAccountProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const SupervisorAccount = forwardRef<SVGSVGElement, SupervisorAccountProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: SupervisorAccountSharp500Fill,
        },
        false: {
          500: SupervisorAccountSharp500,
        },
      },
    };
