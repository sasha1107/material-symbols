...
// Sharp
import UploadFileSharp500Fill from "@material-symbols/svg-500/sharp/upload_file-fill.svg";
import UploadFileSharp500 from "@material-symbols/svg-500/sharp/upload_file.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type UploadFileProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const UploadFile = forwardRef<SVGSVGElement, UploadFileProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: UploadFileSharp500Fill,
        },
        false: {
          500: UploadFileSharp500,
        },
      },
    };
