...
// Sharp
import VerifiedSharp500Fill from "@material-symbols/svg-500/sharp/verified-fill.svg";
import VerifiedSharp500 from "@material-symbols/svg-500/sharp/verified.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type VerifiedProps = IconProps<TVariant, TWeight> &
...
const Verified = forwardRef<SVGSVGElement, VerifiedProps>(
  (
    ...
    > = {
      sharp: {
        true: {
          500: VerifiedSharp500Fill,
        },
        false: {
          500: VerifiedSharp500,
        },
      },
    };
