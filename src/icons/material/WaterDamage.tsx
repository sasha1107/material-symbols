...
// Sharp
import WaterDamageSharp500Fill from "@material-symbols/svg-500/sharp/water_damage-fill.svg";
import WaterDamageSharp500 from "@material-symbols/svg-500/sharp/water_damage.svg";

type TVariant = "sharp";
type TWeight = Extract<TIconWeight, 500>;
type WaterDamageProps = IconProps<TVariant, TWeight> &
  Omit<ComponentProps<"svg">, "width" | "height" | "fill">;
type SVGComponent = React.ForwardRefExoticComponent<
  React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>
>;

const WaterDamage = forwardRef<SVGSVGElement, WaterDamageProps>(
  (
    {
      variant = "sharp",
      size = DEFAULT_SIZE,
    ...
    > = {
      sharp: {
        true: {
          500: WaterDamageSharp500Fill,
        },
        false: {
          500: WaterDamageSharp500,
        },
      },
    };
